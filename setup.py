...
setuptools.setup(
    ...
    description="Scrapy the Zhihu content and user social network information. Now it contains 314400 questions and 261376 users..",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/Zhihu_Spider",  # 模块github地址
